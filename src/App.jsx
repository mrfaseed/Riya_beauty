/*
BeautyParlourApp.jsx
Single-file React component (default export) for an elegant, premium beauty parlour website.

Features:
- Tailwind CSS utility classes
- Framer Motion animations (used lightly)
- Responsive hero, services, gallery, team, booking form, testimonials, footer
- Clean, modern layout (grid + cards), 2xl rounded corners, soft shadows

How to use:
1) Create a new React app (Vite recommended):
   npm create vite@latest beauty-parlour -- --template react
   cd beauty-parlour

2) Install dependencies:
   npm install framer-motion

3) Install and configure Tailwind CSS (follow Tailwind docs). Minimal steps:
   npm install -D tailwindcss postcss autoprefixer
   npx tailwindcss init -p
   // In tailwind.config.cjs set content to ['./index.html', './src//*.{js,jsx,ts,tsx}']
   // In ./src/index.css add the @tailwind base, components, utilities imports

4) Replace src/App.jsx with this file's content and import './index.css' in src/main.jsx.

5) Start dev server: npm run dev

Notes:
- Replace placeholder images and text with real assets.
- If you want the code split into components/files, tell me and I'll split it up for you.
274
*/
...
const services = [
  { id: 1, title: 'Signature Facial', desc: 'Deep-cleansing, hydration and glow.', price: '₹999', icon: '💆‍♀' },
  { id: 2, title: 'Hair Styling', desc: 'Cuts, color and blowouts by pros.', price: '₹799', icon: '✂' },
  ...
  { id: 5, title: 'Therapeutic Massage', desc: 'Relax and restore.', price: '₹699', icon: '🧖‍♂' },
...
<img
  src={`https://i.pravatar.cc/150?img=${idx + 15}`}
  alt={n}
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-1/3 bg-rose-50 rounded-2xl p-6 flex flex-col gap-4">
          ...
          <div className="mt-auto">
            ...
            <div className="font-medium">Riya Beauty Parlour, MG Road, Your City</div>
          </div>
        </div>
      </div>
    </div>
...
const Footer = () => (
  <footer className="bg-gray-900 text-white py-10">
    <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-6">
      <div>
        <div className="text-xl font-bold">Riya</div>
      ...
      <div>
        ...
        <div className="text-gray-400 text-sm mt-2">hello@riya.com</div>
        <div className="text-gray-400 text-sm">+91 90000 00000</div>
      </div>
    </div>
    <div className="mt-8 text-center text-xs text-gray-500">© {new Date().getFullYear()} Riya — All rights reserved.</div>
  </footer>
);
